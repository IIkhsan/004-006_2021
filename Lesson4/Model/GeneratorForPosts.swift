...
class GeneratorForPosts {
    ...
    var photoes: [String] = ["1", "2", "3", "4", "6", "7", "8", "9", "10", "12", "13"]
    ...
    func generateTabel(photoInTable: String?, textInTable: String?, nameInTable: String?, imageInTable: String?, dataInPost: String?) -> Post{
    ...
    func generate() -> Post{
        return generateTabel(photoInTable: photoes.randomElement(),
                             textInTable: textsInPosts.randomElement(),
                             nameInTable: namesInPost.randomElement(),
                             imageInTable: photoes.randomElement(),
    ...
    func generateForPersonFirst() -> Post {
        return generateTabel(photoInTable: photoes.randomElement(),
                             textInTable: textsInPosts.randomElement(),
                             nameInTable: ViewController.personHowLogIn[0].name, imageInTable: photoes.randomElement(),
                             dataInPost: dateInPost.randomElement())
    ...
    func generateForPersonThird() -> Post {
        return generateTabel(photoInTable: photoes.randomElement(),
                             textInTable: " ",
                             nameInTable: ViewController.personHowLogIn[0].name, imageInTable: photoes.randomElement(), dataInPost: dateInPost.randomElement())
    }
