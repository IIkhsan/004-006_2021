...
class DataManager {
    ...
    static func createDefaultUsers(completion: @escaping (([User]) -> Void)) {
        ...
        users.append(User(
            username: "ruslan@mail.ru", password: "pass123", avatarImage: #imageLiteral(resourceName: "user1Avatar"),
        ...
        users.append(User(
            username: "ali@mail.ru", password: "123qwe", avatarImage: #imageLiteral(resourceName: "ali"),
        ...
        users.append(User(
            username: "matt@mail.ru", password: "qwerty1", avatarImage: #imageLiteral(resourceName: "matt"),
